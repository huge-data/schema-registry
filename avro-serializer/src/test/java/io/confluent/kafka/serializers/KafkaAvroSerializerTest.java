...
public class KafkaAvroSerializerTest {
	...
	public KafkaAvroSerializerTest() {
		...
		specificDecoderProps.setProperty(KafkaAvroDeserializerConfig.SCHEMA_REGISTRY_URL_CONFIG, "bogus");
		specificDecoderProps.setProperty(KafkaAvroDeserializerConfig.SPECIFIC_AVRO_READER_CONFIG, "true");
		specificAvroDecoder = new KafkaAvroDecoder(schemaRegistry, new VerifiableProperties(specificDecoderProps));
	}
	...
	private IndexedRecord createAvroRecord2() {
	...
	public void testKafkaAvroSerializer() {
		...
		IndexedRecord avroRecord = createAvroRecord2();
